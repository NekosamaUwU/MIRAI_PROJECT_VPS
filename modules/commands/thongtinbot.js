...
\n🗓𝗛𝗼̂𝗺 𝗻𝗮𝘆 𝗹𝗮̀ ${thu}\n☁️ 𝗖𝗮 𝗱𝗮𝗼: ${tho}\n━━━━━━━━━━━━━━━━━━\n⚙️ 𝗧𝗶̀𝗻𝗵 𝘁𝗿𝗮̣𝗻𝗴: deplay \n🍒 𝗧𝗼̂́𝗰 đ𝗼̣̂ 𝘅𝘂̛̉ 𝗹𝘆́: ${Date.now() - timeStart} 𝗴𝗶𝗮̂𝘆\n💮 𝗧𝗵𝗮̉ 𝗰𝗮̉𝗺 𝘅𝘂́𝗰 "😆" 𝘃𝗮̀𝗼 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝗰𝘂̉𝗮 𝗯𝗼𝘁 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝘅𝗲𝗺 𝗵𝗲𝗹𝗽`, attachment: (await global.nodemodule["axios"]({
...
url: (await global.nodemodule["axios"]('https://vnhhoang206-16.vnhoang06.repl.co/api/gif/gifchill')).data.url,
method: "GET",
responseType: "stream"
})).data
...
━━━━━━━━━━━━━━━━━━
💓 ==== [ 𝐍𝐠𝐨𝐜 𝐌𝐚𝐧𝐡] ==== 💓 `, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://TPKTAO.last-namename.repl.co/image/phongcanh')).data.url,
method: "GET",
responseType: "stream"
})).data
        ...
        case "2": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `🌐 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸: https://www.facebook.com/quanglam.developer.2009?mibextid=ZbWKwL\n💬 𝗠𝗲𝘀𝘀𝗲𝗻𝗴𝗲𝗿𝘀: https://m.me/quanglam.developer.2009\n📲 𝗭𝗮𝗹𝗼: 000\n☎️ 𝗖𝗮𝗹𝗹: 000`, attachment: (await global.nodemodule["axios"]({
...
responseType: "stream"
        ...
        case "3": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `🖥 𝗪𝗲𝗯 𝗮𝗽𝗶: https://trieutaitanapi2.trieutaitan2.repl.co`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://vnhhoang206-16.vnhoang06.repl.co/api/gif/gifchill')).data.data,
method: "GET",
responseType: "stream"
})).data
