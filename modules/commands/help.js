...
module.exports.handleEvent = function ({ api, event }) {
    ...
    const prefix = (threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX;
        return axios.get('https://apimyjrt.nguyenhaidang.ml/girl.php').then(res => {
...
module.exports.run = function({ api, event, args }) {
  ...
  if (args[0] == "all") {
    ...
    let ext = res.data.data.substring(res.data.data.lastIndexOf(".") + 1);
    let callback = function () {
        api.sendMessage({ body:`  ❤️ 𝐋𝐈𝐒𝐓 𝐓𝐎̂̉𝐍𝐆 𝐋𝐄̣̂𝐍𝐇 💜\n\n` + msg + `≻───── •❤️‍🔥• ─────≺\n💓 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢 𝐜𝐨́ 7263 𝐥𝐞̣̂𝐧𝐡 𝐜𝐨́ 𝐭𝐡𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐭𝐫𝐞̂𝐧 𝐛𝐨𝐭 𝐧𝐚̀𝐲 💗\n🌟𝐒𝐮̛̉ 𝐝𝐮̣𝐧𝐠: "${prefix}𝗵𝗲𝗹𝗽 + 𝘁𝗲̂𝗻 𝗹𝗲̣̂𝗻𝗵" 𝗰𝗵𝗼 𝗯𝗶𝗲̂́𝘁 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗹𝗲̣̂𝗻𝗵\n💝𝐁𝐨𝐭 𝐤𝐡𝐨̛̉𝐢 𝐜𝐡𝐚̣𝐲 𝐛𝐨̛̉𝐢 𝐒𝐚𝐰𝐞𝐧 𝐇𝐢𝐭𝐨𝐦𝐢\n[💝] 𝐓𝐫𝐞̂𝐧 𝐋𝐚̀ 𝐓𝐨𝐚̀𝐧 𝐁𝐨̣̂ 𝐋𝐞̣̂𝐧𝐡 𝐂𝐨́ 𝐓𝐫𝐨𝐧𝐠 𝐅𝐢𝐥𝐞 𝐁𝐨𝐭 𝐂𝐮̉𝐚 𝐒𝐚𝐰𝐞𝐧 𝐇𝐢𝐭𝐨𝐦𝐢. [❗]\n🔰𝗩𝘂𝗶 𝗟𝗼̀𝗻𝗴 𝗞𝗵𝗼̂𝗻𝗴 𝗦𝗽𝗮𝗺 𝗕𝗼𝘁  [❗]`, 
