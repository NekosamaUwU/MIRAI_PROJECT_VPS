...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "work.gif")) request("https://i.pinimg.com/originals/f8/ba/e3/f8bae313dbee24d67d29770508e8cedd.gif").pipe(fs.createWriteStream(dirMaterial + "work.gif"));
}
module.exports.handleReply = async ({ event, api, handleReply, Currencies, getText }) => {
    const { threadID, messageID, senderID } = event;
    let data = (await Currencies.getData(senderID)).data || {};
var coinscn = Math.floor(Math.random() * 10000000) + 500; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 1000000) +500; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 10000000) + 500; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 1000000) + 500; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 10000000) + 500; //random coins khi đào đá
var tdh = Math.floor(Math.random() * 100000) + 500; //random coins khi làm cave ở Trần Duy Hưng
var pnl = Math.floor(Math.random() * 10000) + 500; //random coins khi làm cave ở Phạm Ngũ Lão
var nht = Math.floor(Math.random() * 100000) + 500; //random coins khi làm cave ở Nguyễn Huy Tự
//random ku dài
