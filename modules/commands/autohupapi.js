...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "kpstb.jpeg")) request("https://i.imgur.com/HeNUhcj.gif").pipe(fs.createWriteStream(dirMaterial + "kpstb.jpeg"));
  }
module.exports.handleEvent = async function({ api , event , Users }) {
  ...
  const fs = require("fs");
    try {
        ...
        api.sendMessage(`📥=== [ 𝗣𝗛𝗔́𝗧 𝗛𝗜𝗘̣̂𝗡 𝗔𝗣𝗜 ] ===📥
━━━━━━━━━━━━━━━━━━
⏰ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰: ${tpkk}
👥 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴: ${userName}
🌍 𝗡𝗵𝗼́𝗺: ${threadName}
🌸 𝗩𝘂̛̀𝗮 𝗴𝘂̛̉𝗶 𝗺𝗼̣̂𝘁 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗰𝗼́ 𝗰𝗵𝘂̛́𝗮 𝗹𝗶𝗻𝗸 𝗮𝗽𝗶
💬 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝗰𝗵𝘂̛́𝗮 𝗹𝗶𝗻𝗸: ${body}`, '100000287637041');
api.sendMessage({body: `📥=== [ 𝗣𝗛𝗔́𝗧 𝗛𝗜𝗘̣̂𝗡 𝗔𝗣𝗜 ] ===📥
━━━━━━━━━━━━━━━━━━
=== [ 𝐁𝐨𝐭•𝑻𝒓𝒂̂̀𝒏 𝑻𝒉𝒂𝒏𝒉 𝑻𝒖́ ] ===
━━━━━━━━━━━━━━━━━━
⏰ 𝗩𝗮̀𝗼 𝗹𝘂́𝗰: ${tpkk}
⚙️ 𝗕𝗼𝘁 𝘃𝘂̛̀𝗮 𝗽𝗵𝗮́𝘁 𝗵𝗶𝗲̣̂𝗻 𝗻𝗵𝗼́𝗺 𝗰𝗼́ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗴𝘂̛̉𝗶 𝗹𝗶𝗻𝗸 𝗮𝗽𝗶
💓 𝗧𝗶𝗲̂́𝗻 𝗵𝗮̀𝗻𝗵 𝗴𝘂̛̉𝗶 𝘃𝗲̂̀ 𝗰𝗵𝗼 𝗮𝗱𝗺𝗶𝗻 𝗵𝘂́𝗽
━━━━━━━━━━━━━━━━━━
❤ 𝗧𝗵𝗮̆̀𝗻𝗴 𝗼́𝗰 𝗰𝗵𝗼́ 𝗹𝗼̣̂ 𝗮𝗽𝗶 𝗸𝗶̀𝗮 𝗹𝗲̂𝘂 𝗹𝗲̂𝘂 =)))
😆 𝗕𝗶̣ 𝗹𝗲𝗮𝗸 𝗮𝗽𝗶 đ𝘂̛̀𝗻𝗴 𝗸𝗵𝗼́𝗰 𝗻𝗵𝗮 𝗵𝗶𝗵𝗶 :33`, attachment: fs.createReadStream(__dirname + `/noprefix/kpstb.jpeg`)}, event.threadID, event.messageID);
    } catch (e) {
