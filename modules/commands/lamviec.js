...
var coinscn = Math.floor(Math.random() * 900000) + 1; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 5000000) + 1; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 1500000) + 1; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 60000) + 1; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 120000) + 1; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 100000) + 1; //random coins khi đào đá
var coinstb = Math.floor(Math.random() * 900000) + 1; //random coins khi kinh doanh thiết bị
var coinsqt = Math.floor(Math.random() * 700000) + 1; //random quân trang
var coinsso = Math.floor(Math.random() * 800000) + 1; //random duễn viên nhật :)))
