...
url: (await global.nodemodule["axios"]('https://vnhhoang206-9.vnhoang06.repl.co/api/img/phongcanh')).data.data,
method: "GET",
responseType: "stream"
})).data
...
responseType: "stream"
        ...
        case "add": { 
            if (event.senderID != 100000287637041) return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền Admin để thực hiện lệnh`, event.threadID, event.messageID)
