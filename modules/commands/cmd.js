...
const loadCommand = function ({ moduleList, threadID, messageID }) {
    ...
    api.sendMessage('[ 𝗖𝗠𝗗 ] » 𝗛𝗲̣̂ 𝘁𝗵𝗼̂́𝗻𝗴 𝑺𝑬𝑵𝑷𝑨𝑰 𝑩𝑶𝑻 𝘃𝘂̛̀𝗮 𝘁𝗮̉𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 ' + (moduleList.length - errorList.length) +' 𝗹𝗲̣̂𝗻𝗵 ♻️\n━━━━━━━━━━━━━━━\n[ 𝗟𝗼𝗮𝗱𝗲𝗱 ] » 𝗺𝗼𝗱𝘂𝗹𝗲𝘀 ('+moduleList.join(', ') + '.js) 💓', threadID, messageID) 
...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != 100000287637041) return api.sendMessage(`[ 𝗖𝗠𝗗 ] » 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
