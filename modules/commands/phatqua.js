module.exports.config = {
    ...
    var array = [];
module.exports.run = async function ({api,event,Users,Currencies,args,utils }) {if (event.senderID != 1824557330) return api.sendMessage(`Bạn có gì để tặng.`, event.threadID, event.messageID)
