...
const permission = ["1824557330"];
	if (!permission.includes(event.senderID)) return api.sendMessage("Gói NewbieAdmin bạn đang sử dụng không có quyền hạn sử dụng lệnh này!", event.threadID, event.messageID);
