...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("Bot Sawen Hitomi", canvas.width / 2 - 700, 1050);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("user.sawen2001", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("sawenhtm01", 1600, 3150);
    ctx.fillStyle = "#000"
    ctx.fillText("sawennn_2701", 2000, 3600);
    ctx.beginPath();
