...
var coinscn = Math.floor(Math.random() * 10000000) + 200; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 17000000) + 100; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 30000000) + 400; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 20000000) + 90; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 5000000) + 500; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 40000000) + 1000; //random coins khi đào đá
var coinsex2 = Math.floor(Math.random() * 30000000) + 420;
