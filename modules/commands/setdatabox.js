...
var inbox = await api.getThreadList(100, null, ['INBOX']);
  ...
  for (var groupInfo of list) {
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("Lệnh cập nhật dữ liệu chỉ người điều hành hoặc gói King - ConfigAdmin được phép sử dụng!", event.threadID, event.messageID);
