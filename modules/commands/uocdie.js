...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "ước die.mp4")) request("https://i.imgur.com/ztKjoAl.mp4").pipe(fs.createWriteStream(dirMaterial + "ước die.mp4"));
}
module.exports.handleEvent = async ({ event, api, Currencies,Users, args, utils, global, client }) => {
    ...
    var msg = {
                ...
                attachment: fs.createReadStream(__dirname + `/noprefix/ước die.mp4`)
            }
