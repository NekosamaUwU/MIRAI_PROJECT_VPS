...
module.exports.run = async function ({ event, api, Currencies, Users, args }) {
    ...
    if(bet < 20) return HakiraSEND("◈ 𝟭 𝗰𝗼𝗻 𝗻𝗴𝗵𝗲̀𝗼 𝗿𝗮́𝗰𝗵 𝗻𝗵𝘂̛ 𝗺𝗮̀𝘆 𝗰𝘂̃𝗻𝗴 đ𝗼̀𝗶 𝗰𝗵𝗼̛𝗶 𝘁𝗮̀𝗶 𝘅𝗶̉𝘂 𝘀𝗮𝗼?? 𝗖𝘂́𝘁 𝘃𝗲̂̀ 𝗸𝗶𝗲̂́𝗺 𝘁𝗶𝗲̂̀𝗻 đ𝗶 𝗿𝗼̂̀𝗶 𝗵𝗮̆̉𝗻 𝗾𝘂𝗮𝘆 𝗹𝗮̣𝗶 đ𝗮̂𝘆 𝗻𝗵𝗮 𝗵𝗮𝗵𝗮𝗵𝗮𝗵𝗮𝗵𝗮 =)))", threadID, messageID);
