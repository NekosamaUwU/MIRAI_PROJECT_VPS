module.exports = function ({ api, models, Users, Threads, Currencies }) {
  ...
  return async function ({ event }) {
    ...
    if (!ADMINBOT.includes(senderID) && adminbot.adminOnly == true) {
      const res = await axios.get(`https://api-daokieuanh.sawen-team.repl.co/images/phongcanh`);
    ...
    if (!command) {
      const res = await axios.get(`https://TPKTAO.last-namename.repl.co/cadao`);
...
url: (await global.nodemodule["axios"]('https://api-daokieuanh.sawen-team.repl.co/images/phongcanh')).data.data,
method: "GET",
responseType: "stream"
