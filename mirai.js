...
*     ╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚══════╝╚═╝░░╚══╝    *
*                                                        *
* → Sawen Remake -> version 5.0.15                       *
* » Liên hệ trực tiếp «                                  *
* → Facebook: https://www.facebook.com/100000287637041   *
* → Zalo: 0923508547                                     *
* → Donate Momo: 0366205226                              *
* → Dịch vụ Facebook, Tiktok và Instagram đầy đủ         *
* → Chuyên cung cấp Source Encoded - SERASENPAI          *
* ----------------------------------------------------   *
* → Bot Management By: Trần Thanh Tú ( SERA )            *
*   Gmail: vkhanh633@gmail.com                           *
* → Copyright Source: Senpai Team - Senpai Developers      *
**********************************************************`);
